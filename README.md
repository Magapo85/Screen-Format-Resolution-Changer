...
2) In the terminal or command prompt to set 1920*1080 (16/9) => ResChange.exe 16/9
3) In the terminal or command prompt to set 1024*768 (4/3) => ResChange.exe 4/3

You can modifiy (2 lines in the code both format) as your computer possibilites :
-> 1920*1080 (16/9) by 3840x2160 or 1280x720 or 854x480 or other ...
-> 1024*768 (4/3) by 1280*960 or 800*600 or 960*720 or 1440*1080 or other ...
